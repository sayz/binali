...
QUOTES = (
    ...
    "(Hızlı tren kazası ardından) Valla fazla hızlandırmadık, sadece 16 km "
    "hızlandırdık, sıfır kilometre araba bile alındığı gün kaza yapabilir.",

    "Ama biz dedik ki (5 GB yapın). Herkes biraz daha fazla kullansın. "
